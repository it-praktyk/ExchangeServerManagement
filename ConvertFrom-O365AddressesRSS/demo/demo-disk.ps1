...
$xmlFileName = "O365IPAddressesChanges-20160621-233611.xml"
...
ConvertFrom-O365AddressesRSS -Path $xmlFilePath | Export-Csv -Path $generalOutputFilePath -NoTypeInformation -Encoding UTF8

ConvertFrom-O365AddressesRSS -Path $xmlFilePath  | select-object -Property Guid,PublicationDate,DescriptionIsParsable,OperationType,QuickDescription -ExpandProperty SubChanges | Export-Csv -Path $detailOutputFilePath -NoTypeInformation -Encoding UTF8