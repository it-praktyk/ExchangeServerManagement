Function Manage-SecurityGruopsAddresses {

<#   
    .SYNOPSIS   
    Function intended to manage addresses for mail-enabled security groups in Exchange/Active Directory environment
  
    .DESCRIPTION   
    Function intended to manage addresses for mail-enabled security groups in Exchange/Active Directory environment based on input from csv file.
...
BEGIN {
    ...
    [Array]$AcceptedRecipientTypes = @("MailNonUniversalGroup","MailUniversalSecurityGroup")
